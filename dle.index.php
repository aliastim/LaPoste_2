...
<div class="container">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item navbarIndex1-btn">
            <a class="nav-link active" id="forum-tab" data-toggle="tab" href="#events" role="tab" aria-controls="events" aria-selected="true">Événements</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="events" role="tabpanel" aria-labelledby="forum-tab">
